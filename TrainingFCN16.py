...
fcn_32s_checkpoint_path = "./3DBuilderVesselModelForFCN/FCN32_Model/300Epochs/model_fcn32s_3DVessel_300Epochs_with_Rand_TranslationData.ckpt"
...
with tf.Session(config=config)  as sess:
    ...
    for i in range(numOfTrainingIteration * epochs):
        ...
        if i % (numOfTrainingIteration*saveModerForEachN) == 0:
            save_path = saver.save(sess, "./3DBuilderVesselModelForFCN/FCN16_Model/300Epochsmodel_fcn16s_3DVessel_300Epochs_with_Rand_TranslationData_epochNo"+str(i/(numOfTrainingIteration*saveModerForEachN)+1)+".ckpt")
    ...
    save_path = saver.save(sess, "./3DBuilderVesselModelForFCN/FCN16_Model/300Epochs/model_fcn16s_3DVessel_300Epochs_with_Rand_TranslationData.ckpt")
    print("Model saved in file: %s" % save_path)
